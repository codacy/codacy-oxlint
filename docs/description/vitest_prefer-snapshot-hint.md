...
**Pattern ID:** `vitest_prefer-snapshot-hint`
**Plugin:** `vitest`
...
- [Rule Source](https://github.com/oxc-project/oxc/blob/17ae11cd9c00fcb8d16779d30f317f659f0f2e47/crates/oxc_linter/src/rules/vitest/prefer_snapshot_hin
- [oxlint rule reference](https://oxc.rs/docs/guide/usage/linter/rules/vitest/prefer-snapshot-hint.html)
