...
- [Rule Source](https://github.com/oxc-project/oxc/blob/17ae11cd9c00fcb8d16779d30f317f659f0f2e47/crates/oxc_linter/src/rules/jest/require_hook.rs)
- [Upstream rule docs](https://github.com/jest-community/eslint-plugin-jest/blob/main/docs/rules/require-hook.md)
- [Open rule in Oxc Playground](https://playground.oxc.rs/?lintRules=jest%2Frequire-hook)
- [oxlint rule reference](https://oxc.rs/docs/guide/usage/linter/rules/jest/require-hook.html)
