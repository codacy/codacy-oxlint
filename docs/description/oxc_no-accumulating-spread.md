...
**Pattern ID:** `oxc_no-accumulating-spread`
**Plugin:** `oxc`
...
- [Rule Source](https://github.com/oxc-project/oxc/blob/17ae11cd9c00fcb8d16779d30f317f659f0f2e47/crates/oxc_linter/src/rules/oxc/no_accumulating_spread.rs)
- [Open rule in Oxc Playground](https://playground.oxc.rs/?lintRules=oxc%2Fno-accumulating-spread)
- [oxlint rule reference](https://oxc.rs/docs/guide/usage/linter/rules/oxc/no-accumulating-spread.html)
