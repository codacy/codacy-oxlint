...
**Pattern ID:** `typescript_no-unsafe-member-access`
**Plugin:** `typescript`
...
- [Rule Source](https://github.com/oxc-project/oxc/blob/17ae11cd9c00fcb8d16779d30f317f659f0f2e47/crates/oxc_linter/src/rules/typescript/no_unsafe_member_access.rs)
- [Upstream rule docs](https://typescript-eslint.io/rules/no-unsafe-member-access/)
...
- [oxlint rule reference](https://oxc.rs/docs/guide/usage/linter/rules/typescript/no-unsafe-member-access.html)
