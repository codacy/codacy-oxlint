...
**Pattern ID:** `eslint_complexity`
**Plugin:** `eslint`

## What it does

Enforces a maximum [cyclomatic complexity](https://en.wikipedia.org/wiki/Cyclomatic_complexity) in a program, which is the number of linearly independent paths in a program.
...
- [Rule Source](https://github.com/oxc-project/oxc/blob/17ae11cd9c00fcb8d16779d30f317f659f0f2e47/crates/oxc_linter/src/rules/eslint/complexity.rs)
- [Upstream rule docs](https://eslint.org/docs/latest/rules/complexity)
- [Open rule in Oxc Playground](https://playground.oxc.rs/?lintRules=eslint%2Fcomplexity)
- [oxlint rule reference](https://oxc.rs/docs/guide/usage/linter/rules/eslint/complexity.html)
