# Prefer To Have Been Called Times (jest)

**Pattern ID:** `jest_prefer-to-have-been-called-times`
**Plugin:** `jest`
...
- [Rule Source](https://github.com/oxc-project/oxc/blob/17ae11cd9c00fcb8d16779d30f317f659f0f2e47/crates/oxc_linter/src/rules/jest/prefer_to_have_been_called_times.rs)
- [Upstream rule docs](https://github.com/jest-community/eslint-plugin-jest/blob/main/docs/rules/prefer-to-have-been-called-times.md)
- [Open rule in Oxc Playground](https://playground.oxc.rs/?lintRules=jest%2Fprefer-to-have-been-called-times)
- [oxlint rule reference](https://oxc.rs/docs/guide/usage/linter/rules/jest/prefer-to-have-been-called-times.html)
