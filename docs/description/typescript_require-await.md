...
**Pattern ID:** `typescript_require-await`
**Plugin:** `typescript`
...
- [Rule Source](https://github.com/oxc-project/oxc/blob/17ae11cd9c00fcb8d16779d30f317f659f0f2e47/crates/oxc_linter/src/rules/typescript/require_await.rs)
- [Upstream rule docs](https://typescript-eslint.io/rules/require-await/)
- [Rule Source (tsgolint)](https://github.com/oxc-project/tsgolint/blob/main/internal/rules/require_await/require_await.go)
- [oxlint rule reference](https://oxc.rs/docs/guide/usage/linter/rules/typescript/require-await.html)
