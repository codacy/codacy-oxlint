...
**Pattern ID:** `typescript_prefer-reduce-type-parameter`
**Plugin:** `typescript`
...
- [Rule Source](https://github.com/oxc-project/oxc/blob/17ae11cd9c00fcb8d16779d30f317f659f0f2e47/crates/oxc_linter/src/rules/typescript/prefer_reduce_type_parameter.rs)
- [Upstream rule docs](https://typescript-eslint.io/rules/prefer-reduce-type-parameter/)
...
- [oxlint rule reference](https://oxc.rs/docs/guide/usage/linter/rules/typescript/prefer-reduce-type-parameter.html)
